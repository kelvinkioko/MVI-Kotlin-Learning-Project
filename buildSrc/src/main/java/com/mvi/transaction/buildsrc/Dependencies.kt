package com.mvi.transaction.buildsrc
...
object Dependencies {
    ...
    object Koin {
        ...
        const val android_core = "org.koin:koin-andorid-scope:$version"
    ...
    object Retrofit {
        // -- Retrofit2
        private const val retrofit2_version = "2.6.0"
    ...
    object  LeakCanary {
        private const val leak_canary_version = "2.0-alpha-3"
        const val canary = "com.squareup.leakcanary:leakcanary-android:$leak_canary_version"
    }
